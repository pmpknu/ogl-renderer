...
let create_texture width height channels data =
  ...
  Gl.tex_image2d Gl.texture_2d 0 internal_format width height 0 format Gl.unsigned_byte (`Data data);
  Gl.tex_sub_image2d Gl.texture_2d 0 0 0 width height format Gl.unsigned_byte (`Data data);
